...
import { ArrowLeft, UsersRound, Edit, Trash2, UserPlus } from "lucide-react";
        ...
        <TabsContent value="info" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Grup detaylarını görüntüleyin</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium">{group.code}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">
                    Tip
              ...
              {members.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Gruba ilk üyeyi eklemek için yukarıdaki butona tıklayın
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="activity">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Grup aktivitelerini görüntüleyin</CardDescription>
            </CardHeader>
            <CardContent>
