      ...
      <section id="architecture" className="py-24 sm:py-32 bg-white dark:bg-slate-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2">
            <FadeIn delay={0.2}>
              <div className="relative rounded-xl overflow-hidden shadow-xl ring-1 ring-gray-900/10">
                <Image
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <FadeInStagger className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-8 sm:grid-cols-3">
            {t.raw('deployment.options').map((option: any, index: number) => (
              <FadeInChild key={index}>
                <Card className={`hover:shadow-lg transition-all transform hover:scale-105 ${option.tag ? 'border-2 border-blue-500' : ''}`}>
                  <CardHeader>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <a href="https://github.com/yourusername/denetim-uygulamasi" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                    Repository
                  </a>
                </li>
              </ul>
